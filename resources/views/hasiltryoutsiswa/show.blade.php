@extends('layouts.main-layout', ['page_title' => 'Detail Tryout Saya', 'breadcrumb' => ['Data Tryout Saya', 'Detail Tryout Saya'],])
          ...
          <div class="card">
              ...
              <div class="card-footer">
                  <div class="col d-flex justify-content-center">
                      <a href="{{ route('hasiltryoutsiswa.index') }}"><button type="button" style="width: 200px" class="btn btn-block btn-default">Kembali</button></a>
                  </div>
              </div>
          </div>
      </div>
